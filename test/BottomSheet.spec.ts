...
describe('BottomSheet', () => {
  ...
  describe('Opening and Closing', () => {
    ...
    it('emits open event when open is called', async () => {
      const wrapper = mount(BottomSheet, {
        global: { stubs: { teleport: true } },
      })
  ...
  // Snap Points and Height Management
  describe('Snap Points and Height Management', () => {
    ...
    it('emits snapChange event with correct index', async () => {
      const wrapper = mount(BottomSheet, {
        global: { stubs: { teleport: true } },
      })
      ...
      expect(wrapper.emitted('snapChange')![0]).toEqual([1])
    })
  })
  ...
  describe('Dragging Behavior', () => {
    ...
    it('emits dragStart and dragEnd events properly', async () => {
      const wrapper = mount(BottomSheet, {
        global: { stubs: { teleport: true } },
      })
      ...
      expect(wrapper.emitted('dragEnd')![0].length).toBe(1)
    })
  })
